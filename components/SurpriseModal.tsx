...
export const SurpriseModal: React.FC<SurpriseModalProps> = ({ isOpen, onClose, dayData, content, isLoading }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-[#14532d] rounded-2xl shadow-2xl p-6 md:p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto transform transition-all duration-300 ease-in-out scale-95 animate-scale-in border-4 border-yellow-500 relative"
