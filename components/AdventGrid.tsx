...
export const AdventGrid: React.FC<AdventGridProps> = ({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 z-10">
      {/* Grid Container */}
      <div className="grid grid-cols-4 sm:grid-cols-6 gap-4 md:gap-6 p-6 md:p-8 bg-gradient-to-br from-green-900/40 to-red-900/40 backdrop-blur-sm rounded-3xl border-4 border-yellow-500/30 shadow-2xl">
        {days.map((dayInfo) => {
